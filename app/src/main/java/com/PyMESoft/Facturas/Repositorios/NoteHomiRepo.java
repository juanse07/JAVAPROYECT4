package com.PyMESoft.Facturas.Repositorios;
...
import com.PyMESoft.Facturas.DataBases.NoteHomisDataBase;
...
public class NoteHomiRepo {
    ...
    public void  Delete(NoteHomis noteHomis){
        new com.PyMESoft.Facturas.Repositorios.NoteHomiRepo.DeleteNotesProdAsynk(noteHomisDao).execute(noteHomis);

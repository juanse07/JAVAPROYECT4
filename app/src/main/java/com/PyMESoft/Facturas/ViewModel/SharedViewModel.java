package com.PyMESoft.Facturas.ViewModel;

import android.app.Application;

import com.PyMESoft.Facturas.Constructores.NoteHomis;
import com.PyMESoft.Facturas.Constructores.arrayconstructor;
...
import com.PyMESoft.Facturas.MatrizLista;
import com.PyMESoft.Facturas.Repositorio1;
import com.PyMESoft.Facturas.constructornom2;
import com.PyMESoft.Facturas.obtenerdrawer;
...
private MutableLiveData<Double> Taxvalue=new MutableLiveData<>();
    private MutableLiveData<Double> Taxvalue2=new MutableLiveData<>();
    private MutableLiveData<Double> Discountvalue=new MutableLiveData<>();
...
public LiveData<ArrayList<cuerospinner>>getproducto(){
    ...
    ///////getdrawer/////
    public LiveData<Double>getDiscountValue(){return Discountvalue;}
    public void setDiscountvalue(Double input11){
    ...
    public LiveData<Double> getTaxvalue(){return Taxvalue;}
    public void setTaxvalue(Double Input10){
        Taxvalue.setValue(Input10);
    }
    public LiveData<Double> getTaxvalue2(){return Taxvalue2;}
    public void setTaxvalue2(Double Input11){

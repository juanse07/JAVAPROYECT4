...
//            CalcCount=noteProdDao.getCount();
        ...
        public void  Delete(NoteProducto noteProducto){
            new com.PyMESoft.Facturas.NoteProductoRep.DeleteNotesProdAsynk(noteProdDao).execute(noteProducto);

        }
        public void DeleteAllNotes(){
            new com.PyMESoft.Facturas.NoteProductoRep.DeleteAllNotesProdAsynk(noteProdDao).execute();

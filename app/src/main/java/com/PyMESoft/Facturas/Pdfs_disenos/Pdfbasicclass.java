...
public class Pdfbasicclass extends Activity implements Interface2 {
...
//
        ...
        pdfFileConstructor=new PdfFileConstructor();
        pdfFileConstructor.setfile(file2);
//        Log.d("filevalue",String.valueOf(pdfFileConstructor.getfile()));
        setfile2(file2);
...
//        cell1.setPaddingTop(5);
    ...
    public void passFile(File file) {
        file= pdfFileConstructor.getfile();

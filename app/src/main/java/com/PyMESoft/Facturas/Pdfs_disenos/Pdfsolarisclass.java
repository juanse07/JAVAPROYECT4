...
//        context=pdfviewer2.getcontext(context);
        ...
        Font regularHead = new Font(baseFont, 8, Font.NORMAL, BaseColor.WHITE);
        ...
        Font footerE = new Font(baseFont, 8, Font.NORMAL, BaseColor.WHITE);
        Image image;
        ...
        setfile2(file2);
        pdfFileConstructor.setfile(file2);
        ...
        try {
            ...
            String ImageBack= "/storage/emulated/0/PyMESoft/solarisassets/solarispng0.5.png";
            PdfContentByte canvas = writer1.getDirectContentUnder();
            PdfContentByte canvas2 = writer2.getDirectContentUnder();
            Image image2 = Image.getInstance(ImageBack);
            image2.scaleAbsolute(PageSize.LETTER.rotate());
...
//            tableFooter.setTotalWidth(523);
            tableFooter.setTotalWidth(200);
            tableFooter.setWidthPercentage(50);
            tableFooter.setHorizontalAlignment(Element.ALIGN_LEFT|Element.ALIGN_BASELINE);
...
//            mDoc.add(Txterminos);
            ...
            String imgsign = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+ File.separator +
...
//    pdfPtablesign.writeSelectedRows(0,-1,mDoc.left(mDoc.leftMargin()),pdfPtablesign.getTotalHeight()+ mDoc.bottom(mDoc.bottomMargin()),writer2.getDirectContent());
    ...
    public Image LogoImage(float float1,float float2) throws IOException, BadElementException {
        Image image;
        String imFile = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)+ File.separator + "PyMESoft"+File.separator+"Logotipo"+File.separator+"logopng";

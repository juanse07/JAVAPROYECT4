...
import com.PyMESoft.Facturas.AlertDialogos.deletedialogo;
import com.PyMESoft.Facturas.AlertDialogos.sionoalert;
import com.PyMESoft.Facturas.ClickInterface1;
import com.PyMESoft.Facturas.Constructores.constcards;
import com.PyMESoft.Facturas.Downloadpdfclass;
...
//  return listhome == null ? 0:listhome.size();
    }
           ...
           ArrayList<constcards> filteredHomeList=new ArrayList<>();
            if(constraint==null||constraint.length()==0){
                ...
                for(constcards item:listhomefull){
                    if(item.getCliente().toLowerCase().contains(filterHomePattern)||
//                            item.getProducto().toLowerCase().contains(filterHomePattern)||
